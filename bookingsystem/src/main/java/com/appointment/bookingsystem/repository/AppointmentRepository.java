...
public interface AppointmentRepository extends JpaRepository<Appointment, Long> {
    ...
    @Query("SELECT a FROM Appointment a WHERE a.doctor.id = :doctorId AND a.patient.name LIKE %:patientName%")
    List<Appointment> findByDoctorIdAndPatientName(Long doctorId, String patientName);
}
